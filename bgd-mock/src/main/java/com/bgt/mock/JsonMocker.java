package com.bgt.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.bgt.mock.util.*;
...
public class JsonMocker {
    ...
    RanOpt[] areaOpts = {new RanOpt("sihaodi", 10),
            new RanOpt("yanglijiacun", 10), new RanOpt("siziwangqi", 20), new RanOpt("shangdu", 5),
            new RanOpt("jining", 5), new RanOpt("erlian", 5), new RanOpt("zhaluteqi", 5),
            new RanOpt("yushuwan", 5), new RanOpt("xijing", 5), new RanOpt("hushi", 5)
    };
    RandomOptionGroup<String> areaOptionGroup = new RandomOptionGroup(areaOpts);

    String appId = "how-do-you-do";
