...
public class MockData {
    ...
    private static String[] road = "商都,凉城,四子王旗,二连浩特,乌兰察布,呼和浩特,扎鲁特旗".split(",");
    //商都，凉城，四子王旗，二连浩特，乌兰察布，呼和浩特，扎鲁特旗
    ...
    public static void getLog() {
        MockData jsonMocker = new MockData();
        jsonMocker.startupNum = 1000000;
        for (int i = 0; i < jsonMocker.startupNum; i++) {
            String startupLog = jsonMocker.initDataLog();
